    ...
    <div className="space-y-6 text-[#f7f8f8] max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#ffffff0e] pb-5">
        <div className="flex items-center space-x-3">
          <div className="w-8 h-8 rounded-md bg-[#16191e] border border-[#ffffff12] flex items-center justify-center text-[#f87171]">
            <HeartPulse className="w-4 h-4" />
          </div>
          <div>
            <h1 className="text-base font-semibold text-[#f7f8f8] tracking-tight">Diário de Saúde & Hábitos Biológicos</h1>
            <p className="text-xs text-[#8a8f98]">Acompanhamento de sono, hidratação, estresse e atividades físicas</p>
          </div>
        </div>
