...
MOTIVO: Prevenir vazamento de dados de producao para dev e execucao acidental de codigo destrutivo no ambiente errado.

GATILHO: Ativado ao configurar variaveis de ambiente, connection strings ou deploy configs.

SEGREGACAO OBRIGATORIA:

-	Bancos Separados: Cada ambiente (dev, staging, prod) DEVE ter seu proprio banco de dados. Nunca compartilhe.
-	Prefixos de Variaveis: Use prefixos claros: DEV_, STAGING_, PROD_ para diferenciar configs.
-	Feature Flags: Codigo nao finalizado deve estar atras de feature flags, nunca commitado diretamente em main/master.
