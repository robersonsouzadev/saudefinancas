...
Arquitetura Limpa Smith
MOTIVO: Combater o codigo sujo e a duplicacao de logica (o "copia e cola" do passado).

GATILHO: Ativado ao criar novos arquivos de routers, services, ou ao adicionar logica de negocio em qualquer camada.

ESTRUTURA DE CAMADAS:

-	Services (Logica de Negocio): Regras complexas (calculo de preco, RAG, processamento de WhatsApp) residem estritamente em /app/services/.
-	Routers (Interface): Rotas de API devem apenas validar o input e chamar os servicos necessarios.
-	DRY (Don't Repeat Yourself): Se a logica de calculo de tokens ou billing for necessaria em mais de um lugar, ela deve ser centralizada no UsageService ou BillingCore.
