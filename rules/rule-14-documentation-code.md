...
MOTIVO: Codigo auto-documentado reduz overhead de manutencao e evita docs desatualizados.

GATILHO: Ativado ao criar funcoes, classes, modulos ou arquivos README.

HIERARQUIA DE CLAREZA:

1.	Nomes Descritivos: Prefira user_email sobre ue, calculate_monthly_revenue sobre calc.
2.	Funcoes Pequenas: Cada funcao deve fazer UMA coisa. Se precisar de "e" na descricao, quebre em duas.
3.	Docstrings Obrigatorios: Toda funcao publica deve ter docstring com: descricao, parametros, retorno, excecoes.
